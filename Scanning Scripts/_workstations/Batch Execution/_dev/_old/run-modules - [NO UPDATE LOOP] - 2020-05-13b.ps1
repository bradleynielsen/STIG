...
#region:    Config
    ...
    $jobTimeout =  2 # [number of Hours]         set the timeout for all jobs (Total time will not exeed this number) 
...
#region:    Summary
    ...
    $testingJobs | Wait-Job -timeout ($jobTimeout*60*60) # Total job timeout in hours
