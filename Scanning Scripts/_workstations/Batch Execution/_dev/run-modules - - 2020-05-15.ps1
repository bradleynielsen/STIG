...
#region:    Config
    ...
    $timeout    =  0 # [number seconds | 0: OFF] set the timeout for WinRM (prevents endless loop) 
    $jobTimeout =  1 # [number of Hours]         set the timeout for all jobs (Total time will not exeed this number) 
